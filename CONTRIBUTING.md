...
The following is a set of guidelines for contributing to slack-random-emoji-service. We really appreciate that you are considering contributing!
...
Follow our [Installation Guide](https://github.com/ciroque/slack-random-emoji-service/blob/main/README.md#Installation) to get the slack-random-emoji-service up and running.
...
* Fill in [our pull request template](https://github.com/{ciroque/slack-random-emoji-service/blob/main/.github/pull_request_template.md).
